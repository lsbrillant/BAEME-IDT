...
public class LogTableModel extends AbstractTableModel {
    ...
    public LogTableModel(LogTableController controller) {
        ...
        this.columnNames = new String[]{"Number", "Host", "Method", "Tag", "URL", "Params", "Edited", "Code", "Length", "MIME", "Extension", "Title", "TLS", "IP", "Cookies", "Time", "Status", "Debug","Tags"}; // TODO: add all of them here
